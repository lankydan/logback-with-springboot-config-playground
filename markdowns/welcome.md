...
If you liked this post my personal blog can be found at [www.lankydanblog.com](http://www.lankydanblog.com) and contains similar and different content, with most being centered around Java. The code used in this post can be found on my [GitHub](https://github.com/lankydan/logback-with-springboot-config) and the source for this post, which contains more broken up examples that I couldn't manage to embed into runnable code snippets can be found [here](https://github.com/lankydan/logback-with-springboot-config-playground).
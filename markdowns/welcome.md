...
@[Application]({"stubs": ["src/main/resources/logback-example-1.xml"],"command": "com.lankydan.ApplicationTest#testOne -Dlogging.config=src/main/resources/logback-example-1.xml"})
